...
function partDiagram(p){var label=h(p.name);return '<svg viewBox="0 0 420 220" role="img" aria-label="Simplified 2D diagram of '+label+'"><rect x="28" y="28" width="364" height="164" rx="18" fill="none" stroke="currentColor" opacity=".14"/><circle cx="210" cy="110" r="54" fill="none" stroke="currentColor" stroke-width="3" opacity=".65"/><path d="M92 110h64M264 110h64M210 56V28M210 164v28" stroke="currentColor" stroke-width="3" opacity=".45"/><circle cx="210" cy="110" r="18" fill="currentColor" opacity=".10"/><text x="210" y="114" text-anchor="middle" font-size="12" font-weight="700" fill="currentColor">'+label+'</text><text x="210" y="145" text-anchor="middle" font-size="10" fill="currentColor" opacity=".55">2D location / function reference</text></svg>';}
...
setTimeout(function(){renderPartsManual('');updateTruckIssuePins();},0);
