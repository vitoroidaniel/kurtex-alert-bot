...
async function loadPartCases(p){
 ...
 }catch(e){el.innerHTML='<div class="intel-empty ai-empty"><i class="ph ph-cloud-slash"></i><strong>AI matching unavailable</strong><span>No fallback cases are shown to avoid misleading agents.</span></div>';}
}
