...
function partDiagram(p){
  var label=h(p.name), k=(p.id+' '+p.name+' '+p.keywords).toLowerCase();
  var shape='';
  if(k.includes('thermostat')) shape='<g><circle cx="210" cy="108" r="50" fill="#dfe3e8" stroke="#20242a" stroke-width="5"/><circle cx="210" cy="108" r="24" fill="#b9c0c8" stroke="#20242a" stroke-width="4"/><path d="M210 58v-24M180 65l-18-21M240 65l18-21M210 132v42" stroke="#20242a" stroke-width="7" stroke-linecap="round"/><path d="M188 174h44" stroke="#20242a" stroke-width="8" stroke-linecap="round"/><path d="M177 108h66" stroke="#c43b3b" stroke-width="6" stroke-linecap="round"/></g>';
  else if(k.includes('air spring')||k.includes('air bag')) shape='<g><rect x="162" y="42" width="96" height="18" rx="5" fill="#aab1b8"/><path d="M175 61C160 78 160 92 174 106C160 121 161 139 177 154H243C259 139 260 121 246 106C260 92 260 78 245 61Z" fill="#34383d" stroke="#17191c" stroke-width="4"/><path d="M177 106h69" stroke="#737b84" stroke-width="5"/><rect x="168" y="154" width="84" height="23" rx="6" fill="#aab1b8"/><circle cx="188" cy="51" r="4" fill="#c43b3b"/><circle cx="232" cy="51" r="4" fill="#c43b3b"/></g>';
  else if(k.includes('battery')) shape='<g><rect x="135" y="62" width="150" height="100" rx="10" fill="#30343a" stroke="#17191c" stroke-width="5"/><rect x="153" y="48" width="26" height="16" rx="4" fill="#c43b3b"/><rect x="241" y="48" width="26" height="16" rx="4" fill="#707780"/><path d="M163 96h20M173 86v20M239 96h20" stroke="#f4f4f4" stroke-width="5" stroke-linecap="round"/><rect x="154" y="124" width="112" height="20" rx="4" fill="#555c64"/></g>';
  else if(k.includes('brake chamber')) shape='<g><ellipse cx="195" cy="108" rx="64" ry="58" fill="#7a8189" stroke="#20242a" stroke-width="5"/><rect x="195" y="53" width="48" height="110" rx="20" fill="#979ea6" stroke="#20242a" stroke-width="4"/><path d="M243 108h72" stroke="#20242a" stroke-width="10" stroke-linecap="round"/><circle cx="317" cy="108" r="9" fill="#c43b3b"/></g>';
  else if(k.includes('air dryer')) shape='<g><rect x="169" y="45" width="82" height="132" rx="30" fill="#555c64" stroke="#20242a" stroke-width="5"/><rect x="179" y="30" width="62" height="26" rx="7" fill="#9da4ab" stroke="#20242a" stroke-width="4"/><path d="M185 177v15M235 177v15" stroke="#20242a" stroke-width="7"/><path d="M251 88h42M127 88h42" stroke="#c43b3b" stroke-width="7" stroke-linecap="round"/></g>';
  else if(k.includes('fifth wheel')) shape='<g><path d="M122 76C122 53 146 42 171 42H249C274 42 298 53 298 76V158H253V113C253 92 236 78 210 78C184 78 167 92 167 113V158H122Z" fill="#4d535a" stroke="#20242a" stroke-width="5"/><path d="M210 42v47" stroke="#f4f4f4" stroke-width="10"/><circle cx="210" cy="112" r="12" fill="#c43b3b"/></g>';
  else if(k.includes('tire')||k.includes('wheel')||k.includes('hub')) shape='<g><circle cx="210" cy="110" r="72" fill="#25282c"/><circle cx="210" cy="110" r="45" fill="#aeb4ba" stroke="#20242a" stroke-width="5"/><circle cx="210" cy="110" r="15" fill="#555c64"/><g stroke="#555c64" stroke-width="4"><path d="M210 65v30M210 125v30M165 110h30M225 110h30M178 78l21 21M221 121l21 21M242 78l-21 21M199 121l-21 21"/></g></g>';
  else if(k.includes('turbo')) shape='<g><path d="M210 48c-52 0-84 32-84 70 0 34 26 59 59 59 34 0 57-22 57-50 0-25-19-42-42-42-19 0-32 12-32 28 0 14 10 24 23 24 12 0 20-8 20-18" fill="#9aa1a8" stroke="#20242a" stroke-width="6"/><path d="M238 72h70v44h-58" fill="#747b83" stroke="#20242a" stroke-width="6"/><circle cx="195" cy="116" r="8" fill="#c43b3b"/></g>';
  else if(k.includes('dpf')||k.includes('scr')) shape='<g><rect x="120" y="72" width="180" height="76" rx="35" fill="#8d949c" stroke="#20242a" stroke-width="5"/><path d="M90 110h30M300 110h30" stroke="#20242a" stroke-width="14"/><path d="M165 79v62M210 79v62M255 79v62" stroke="#c4c9ce" stroke-width="4"/><circle cx="210" cy="110" r="8" fill="#c43b3b"/></g>';
  else if(k.includes('def')) shape='<g><path d="M145 68h118l18 24v70H139V92Z" fill="#d8dde2" stroke="#20242a" stroke-width="5"/><rect x="178" y="48" width="58" height="23" rx="6" fill="#4c82a8"/><path d="M181 117c16-27 42-27 58 0-16 28-42 28-58 0Z" fill="#4c82a8"/></g>';
  else if(k.includes('reefer')) shape='<g><rect x="126" y="43" width="168" height="134" rx="10" fill="#eceff1" stroke="#20242a" stroke-width="5"/><circle cx="173" cy="92" r="29" fill="#aeb5bc" stroke="#20242a" stroke-width="4"/><circle cx="247" cy="92" r="29" fill="#aeb5bc" stroke="#20242a" stroke-width="4"/><path d="M173 70v44M151 92h44M247 70v44M225 92h44" stroke="#59616a" stroke-width="4"/><rect x="153" y="139" width="114" height="18" rx="4" fill="#c43b3b" opacity=".85"/></g>';
  else shape='<g><path d="M210 44l18 16 24-4 10 23 23 10-4 24 16 18-16 18 4 24-23 10-10 23-24-4-18 16-18-16-24 4-10-23-23-10 4-24-16-18 16-18-4-24 23-10 10-23 24 4Z" fill="#a8afb6" stroke="#20242a" stroke-width="5"/><circle cx="210" cy="131" r="38" fill="#f5f6f7" stroke="#20242a" stroke-width="5"/><circle cx="210" cy="131" r="12" fill="#c43b3b"/></g>';
  return '<svg viewBox="0 0 420 220" role="img" aria-label="Illustrated part view of '+label+'"><rect x="1" y="1" width="418" height="218" rx="18" fill="#f7f8f9" stroke="#e1e4e7"/>'+shape+'<text x="210" y="207" text-anchor="middle" font-size="12" font-weight="700" fill="#30343a">'+label+'</text></svg>';
}
...
function selectPart(id){var p=partsDB.find(function(x){return x.id===id});if(!p)return;selectedPart=id;var d=document.getElementById('part-detail');if(!d)return;d.dataset.ready='1';d.innerHTML='<div class="part-hero"><div><span class="eyebrow">'+h(p.cat.toUpperCase())+' · '+h(p.loc.toUpperCase())+'</span><h2>'+h(p.name)+'</h2><p>'+h(p.what)+'</p></div><button class="part-3d-btn" onclick="showPartOnTruck(\''+p.id+'\')"><i class="ph ph-cube"></i> View in 3D Lab</button></div><div class="part-visual-head"><div><span class="part-label">PART VIEW</span><strong>What it looks like</strong></div><small>Colored technical illustration · use the OEM source below for model-specific identification</small></div><div class="part-diagram">'+partDiagram(p)+'</div><div class="part-info-grid"><article><span class="part-label">HOW IT WORKS</span><p>'+h(p.works)+'</p></article><article><span class="part-label">COMMON ISSUES</span><ul>'+p.issues.map(function(x){return '<li>'+h(x)+'</li>'}).join('')+'</ul></article><article><span class="part-label">QUICK CHECKS</span><ol>'+p.checks.map(function(x){return '<li>'+h(x)+'</li>'}).join('')+'</ol></article><article class="part-fix"><span class="part-label">FIX / NEXT ACTION</span><p>'+h(p.fix)+'</p></article></div><a class="part-source" href="'+p.url+'" target="_blank" rel="noopener"><i class="ph ph-arrow-square-out"></i><span><strong>Source / further reading</strong><small>'+h(p.source)+'</small></span></a>';renderPartsManual(document.getElementById('parts-search')?document.getElementById('parts-search').value:'');}
function showPartOnTruck(id){showPage('truck_lab');var map={airspring:'airbag',airdryer:'lowair',brakechamber:'brakeheat',battery:'nostart',thermostat:'overheat',reeferunit:'reefercool'};setTimeout(function(){if(map[id])openTruckIssue(map[id]);},0);}
